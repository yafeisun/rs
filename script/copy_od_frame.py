...
def extract_od_frame(car_path, target_root, period="total"):
    ...
    for item in abs_bag_paths:
        ...
        #     os.makedirs(new_bag_path)
            try:
                print(f"cp {os.path.basename(item)} to {new_car_path}")
                subprocess.run(["cp", "-rp", item, new_car_path], check=True)                
            except Exception as e:
                print(f"cp failed: {e}")

if __name__ == "__main__":
    # 获取目标文件夹路径参数
    dir_root = "/home/geely/nas/PLD-S6B/J6M-S08"
    target_root = "/home/geely/nas/PLD-S6C/4D-OD/4D-OD-XUANKONGZHANGAIWU/S23-0622-OD-OCC"
    ...
    # day_dirs = []
    # day_dirs.append("20250611")
    # day_dirs.append("20250612")

    vincodes = []
    # vincodes.append("0143")
    ...
    abs_car_dirs = []
    abs_car_dirs.append("/home/geely/nas/PLD-S6C/J6M-S23/20250622/P181_0251_20250622_1503")
    abs_car_dirs.append("/home/geely/nas/PLD-S6C/J6M-S23/20250622/P181_0251_20250622_1519")
    abs_car_dirs.append("/home/geely/nas/PLD-S6C/J6M-S23/20250622/P181_0251_20250622_1750")
    abs_car_dirs.append("/home/geely/nas/PLD-S6C/J6M-S23/20250622/P181_0251_20250622_1843")
    abs_car_dirs.append("/home/geely/nas/PLD-S6C/J6M-S23/20250622/P181_0251_20250622_1943")

    period = "total" # "" == total, "day", "night"
    total_bag_dirs = []
